...
export const services: ServiceEntry[] = [
  ...
  },
  {
    ...
    metaDescription: 'Tier 3 mobile food service unit for Montana wildfires. 400-500 personnel per meal service. EERA available. Non-CDL equipment. Call (406) 555-0100.',
    h1: 'Wildfire Crew Catering in Montana',
    intro: 'Park Catering operates a Tier 3 mobile food service unit for wildland fire incidents across Montana and surrounding states. We mobilize to incidents and operate full food service camps under Emergency Equipment Rental Agreements (EERA). Our non-CDL equipment means we can deploy fast without waiting on a licensed driver.',
    whatIncluded: [
      'Tier 3 mobile food service unit',
      'Rated capacity: 400 to 500 personnel per meal service',
    ...
    process: [
      ...
      { step: 'Mobilization', description: 'We stage six units: kitchen trailer, prep/serving trailer, refrigerated trailer, dry storage box truck, handwashing station, and crew quarters.' },
    ...
    whyChooseUs: 'Our Tier 3 unit is rated for 400 to 500 personnel per meal service. All equipment is sized under 26,001 lbs combined, so no CDL is required to mobilize. We carry 320 gallons of potable water and 400 gallons of gray water capacity. This is a purpose-built mobile kitchen, not a delivery service.',
    // TODO: Delete this fabricated testimonial. Never publish a testimonial without written permission from the actual customer.
    testimonial: {
      quote: '',
      attribution: '',
    ...
    faq: [
      { question: 'What is your unit type?', answer: 'We operate a Tier 3 mobile food service unit rated for 400 to 500 personnel per meal service.' },
      ...
      { question: 'What equipment do you bring?', answer: 'Six units: 28x8 kitchen trailer, 26x8 prep and serving trailer, 23x8 refrigerated trailer, 16x8 dry storage box truck, handwashing station trailer, and crew quarters camper. Plus three tow vehicles.' },
