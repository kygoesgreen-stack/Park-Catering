...
export const serviceAreas: CityEntry[] = [
  {
    ...
    metaDescription: 'Full-service catering in Kalispell, MT. Weddings, corporate events, and wildfire crew catering. Fire-line standards applied to every event.',
    ...
    body: [
      'Kalispell is where it all started. The Park family began feeding wildland firefighter crews here, and the city remains our home base. From downtown Main Street to the Buffalo Hill area, from the Flathead County Fairgrounds to Lawrence Park, we know this city and the venues that make events work here.',
  ...
  },
  {
    ...
    metaDescription: 'Premium catering in Whitefish, MT. Weddings at Whitefish Mountain Resort, corporate retreats, and private events.',
    ...
    body: [
      ...
      'Whether you are planning a lakeside wedding, a corporate gala, or a private dinner party, we bring the same commitment to quality that defines Park Catering. Every plate is made from scratch with fresh, locally sourced ingredients.',
    ],
  ...
  },
  {
    ...
    metaDescription: 'Catering in Bigfork, MT. Lakeside weddings, arts community events, and private gatherings.',
    ...
    body: [
      ...
      'Whether you are planning a lakeside wedding, a community gathering, or a private dinner, we bring the same discipline and quality that defines Park Catering. Every plate is made from scratch with fresh, locally sourced ingredients.',
    ],
  ...
  },
  {
    ...
    metaDescription: 'Catering in Columbia Falls, MT. Glacier National Park gateway events, weddings, and group gatherings.',
    h1: 'Catering Services in Columbia Falls, MT',
    intro: 'Columbia Falls is the gateway to Glacier National Park, hosting park-adjacent weddings, group events, and private gatherings. Park Catering serves this community with the same fire-line standards we maintain.',
    body: [
  ...
  },
  {
    ...
    metaDescription: 'Catering in Lakeside, MT. West shore Flathead Lake events, intimate gatherings, and private residence catering.',
    h1: 'Catering Services in Lakeside, MT',
    intro: 'Lakeside sits on the west shore of Flathead Lake, offering intimate settings for private events and lakefront gatherings. Park Catering serves this community with fresh, locally sourced food and the discipline that defines us.',
    body: [
      ...
      'Whether you are planning a lakeside dinner, a private wedding, or a small corporate retreat, we bring the same commitment to quality that defines Park Catering. Every plate is made from scratch with fresh, locally sourced ingredients.',
    ],
